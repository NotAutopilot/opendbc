...
FW_VERSIONS = {
  ...
  CAR.TESLA_MODEL_S_PREAP: {
    ...
    # Note: Pre-AP typically requires force fingerprint as CAN messages vary by vehicle config
    # This fingerprint is from Tinkla's 2013 base Model S
    (Ecu.eps, 0x730, None): [
      b'PREAP_FORCE_FP',  # Force fingerprint required - set via settings UI
    ],
  },
}

# Pre-AP CAN fingerprint from Tinkla (2013 base Model S)
# This is for reference/alternative fingerprinting - pre-AP usually needs force FP
PREAP_CAN_FINGERPRINT = {
